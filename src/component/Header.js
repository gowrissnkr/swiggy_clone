...
import LOGO_SVG from "../assets/swiggy.svg";
...
const Header = () => {
    const cartItemLength = useSelector((store) => store.data.cartItem)
        ...
        <>
            <header className="fixed top-0 z-[1000] w-full h-[80px] bg-white px-5 shadow-[0_15px_40px_-20px_rgba(40,44,63,0.15)]">
                <div className="h-full min-w-[1200px] max-w-[1200px] flex mx-auto">
                    <a href="/" className="w-14 h-14 self-center">
                        <img className="" src={LOGO_SVG} alt="" />
                    </a>
                    <div className="ml-8 h-10 flex items-center max-w-xs self-center cursor-pointer hover:text-[#fc8019] text-sm group" onClick={() => setShowSideBar(true)} >
                        ...
                        <span className="ml-2 font-light group-hover:text-[#686b78a7] text-[#686b78] truncate text-ellipsis">Coimbatore, TamilNadu, India</span>
                    ...
                    <ul className="flex flex-1 justify-end items-center h-full text-sm">
                        ...
                        <Link to="/cart">
                        <li className={`last:mr-0 font-semibold  hover:text-[#fc8019] group cursor-pointer`}>
                            <a className="flex" to="/checkout">
                                <span className="mr-2.5 flex relative">
                                    <svg className={`fill-[#60b246] group-hover:fill-[#fc8019]  group-hover:stroke-[#fc8019] stroke-[#60b246]`} viewBox="-1 0 37 32" height="20" width="22" fill="#686b78">
